...
*/
$IMConfig['base_dir'] = $srv_settings['dir_files_full'];
# $IMConfig['base_dir'] = '/home/yourtest/public_html/igivetest/try/files/';
...
*/
$IMConfig['base_url'] = $srv_settings['url_files'];
# $IMConfig['base_url'] = 'http://domain.com/try/files/';
...
/*
 ...
 NOTE: If $IMConfig['safe_mode'] = true, this parameter
       is ignored, you can not create directories
*/
$IMConfig['allow_new_dir'] = ($G_SESSION['access_questionbank'] > 1) || ($G_SESSION['access_testmanager'] > 1);
...
*/
$IMConfig['allow_upload'] = ($G_SESSION['access_questionbank'] > 1) || ($G_SESSION['access_testmanager'] > 1);
