...
<div class="logo">
 <h1 id="name-text" class="logo-name"><a href="<?php echo $this->baseurl ?>/">On The Beach</a></h1>
 <div id="slogan-text" class="logo-text">lorem ipsum dolor sit</div>
</div>
...
<div class="boxes">
  <jdoc:include type="modules" name="user4" style="artblock" />
</div>
<div class="cleared"></div>
</div>
...
All Rights Reserved.</p>
 ...
 <div class="Footer-background"></div>
  ...
  <p class="page-footer"><a href="http://joomlacmstemplates.blogspot.com">Joomla Template</a> created by <a href="http://joomlacmstemplates.blogspot.com">JB Joomla 1.5 Templates</a>.</p>
