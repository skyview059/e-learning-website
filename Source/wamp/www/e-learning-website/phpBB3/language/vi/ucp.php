...
$lang = array_merge($lang, array(
	...
	<br />
	Tài khoản thành viên của bạn chỉ bao gồm tối thiểu một tên thành viên để định danh (Hiểu ở đây là “tên thành viên của bạn”), một mật khẩu cá nhân dùng để đăng nhập vào tài khoản thành viên của bạn (Hiểu ở đây là “mật khẩu của bạn”) và một địa chỉ Email cá nhân hợp lệ (Hiểu ở đây là “địa chỉ Email của bạn”). Thông tin của bạn chứa trong tài khoản thành viên tại website “%1$s” được bảo hộ bởi luật bảo vệ thông tin áp dụng tại quốc gia nơi đặt máy chủ cho website của chúng tôi. Bất kỳ thông tin nào khác ngoài tên thành viên của bạn, mật khẩu của bạn và địa chỉ Email của bạn được yêu cầu phải cung cấp bởi website “%1$s” trong suốt quá trình đăng ký làm thành viên tại đây là những thông tin tuỳ chọn có tính bắt buộc chỉ của riêng website này, không phải yêu cầu của hệ thống phpBB. Trong tất cả trường hợp, bạn đều có tuỳ chọn hiển thị hay không hiển thị những thông tin này cho mọi người biết trong phần thiết lập cá nhân của mình. Hơn nữa, trong tài khoản thành viên của bạn, bạn cũng có tuỳ chọn hiển thị hay ẩn đi địa chỉ Email của mình từ hệ thống phpBB để thoát khỏi sự tò mò của người khác hay các cỗ máy dò tìm địa chỉ Email.<br />
	<br />
	Mật khẩu của bạn được bảo vệ bằng phương pháp mã hoá trong cơ sở dữ liệu của hệ thống, vì thế nó rất an toàn. Tuy nhiên, chúng tôi khuyên bạn không nên dùng lại mật khẩu này trên các website khác. Mật khẩu của bạn là cách duy nhất để bạn đăng nhập vào tài khoản thành viên của mình trong website “%1$s”, vì thế hãy cất giữ nó cẩn thận và trong trường hợp nào cũng không cung cấp cho bất kỳ ai có quan hệ với website “%1$s”, phpBB hay bất kỳ người thứ ba nào khác ngoại trừ yêu cầu mật khẩu của bạn là hợp pháp. Bạn cũng đừng nên quên mật khẩu tài khoản thành viên của mình, nếu quên, bạn có thể sử dụng chức năng “Quên mật khẩu” từ hệ thống phpBB. Để thực hiện việc này, bạn cần phải cung cấp cho hệ thống biết tên thành viên và địa chỉ Email đang sử dụng của mình trong tài khoản, sau đó hệ thống phpBB sẽ tạo ra cho bạn mật khẩu mới và gửi đến cho bạn để bạn vẫn có thể sử dụng được tài khoản thành viên của mình.<br />
	',
));
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'				=> 'Tài khoản của bạn đã được tạo. Tuy nhiên, hệ thống yêu cầu bạn phải tự kích hoạt tài khoản của mình. Một khoá kích hoạt đã được gửi đến địa chỉ Email mà bạn đã dùng để đăng ký thành viên. Hãy kiểm tra Email của bạn để biết thêm thông tin.',
	...
	'ACTIVATION_EMAIL_SENT_ADMIN'	=> 'Email kích hoạt vừa được gửi tới nhà quản trị.',
	'ADD'							=> 'Thêm vào',
	...
	'ADD_NEW_RULE'					=> 'Thêm quy định cá nhân mới',
	'ADD_RULE'						=> 'Thêm quy định cá nhân',
	'ADD_TO'						=> 'Thêm vào [Người nhận]',
	'ADD_USERS_UCP_EXPLAIN'			=> 'Nơi đây bạn có thể thêm thành viên mới vào nhóm. Bạn có thể lựa chọn nhóm này như là mặc định cho các thành viên được chọn. Hãy nhập vào tên thành viên mỗi người trên mỗi dòng.',
	...
	'BOOKMARKS_EXPLAIN'			=> 'Bạn có thể đánh dấu những chủ đề mình yêu thích trong trang này để dễ dàng xem lại sau này. Đánh dấu chọn vào ô kiểm trong bất cứ trang đánh dấu nào mà bạn muốn xoá rồi bấm vào nút <strong>Gỡ bỏ những trang yêu thích đã đánh dấu</strong>.',
	...
	'CANNOT_EDIT_MESSAGE_TIME'		=> 'Bạn không còn có thể sửa hay xoá tin nhắn này.',
	...
	'CLICK_GOTO_FOLDER'				=> '%1$sChuyến đến thư mục “%3$s” của bạn%2$s',
	...
	'CUR_PASSWORD_EMPTY'		=> 'Bạn chưa nhập mật khẩu hiện tại của bạn.',
	...
	'DEFINED_RULES'				=> 'Những quy định cá nhân đã xác lập',
	'DELETED_TOPIC'				=> 'Chủ đề đã được gỡ bỏ.',
	'DELETE_ATTACHMENT'			=> 'Xoá tập tin đính kèm này',
	'DELETE_ATTACHMENTS'		=> 'Xoá những tập tin đính kèm này',
	'DELETE_ATTACHMENT_CONFIRM'	=> 'Bạn có chắc chắn muốn xoá tập tin đính kèm này?',
	'DELETE_ATTACHMENTS_CONFIRM'=> 'Bạn có chắc chắn muốn xoá những tập tin đính kèm này?',
	'DELETE_AVATAR'				=> 'Xoá hình đại diện hiện tại',
	'DELETE_COOKIES_CONFIRM'	=> 'Bạn có chắc chắn muốn xoá tất cả các cookie được tạo bởi website này?',
	'DELETE_MARKED_PM'			=> 'Xoá những tin nhắn đã đánh dấu',
	'DELETE_MARKED_PM_CONFIRM'	=> 'Bạn có chắc chắn muốn xoá những tin nhắn đã đánh dấu?',
	'DELETE_OLDEST_MESSAGES'	=> 'Xoá những tin nhắn cũ',
	'DELETE_MESSAGE'			=> 'Xoá tin nhắn',
	'DELETE_MESSAGE_CONFIRM'	=> 'Bạn có chắc chắn muốn xoá tin nhắn này?',
	'DELETE_MESSAGES_IN_FOLDER'	=> 'Xoá tất cả tin nhắn trong thư mục gỡ bỏ',
	'DELETE_RULE'				=> 'Xoá quy định cá nhân',
	...
	'DRAFTS_DELETED'			=> 'Tất cả bản nháp bạn vừa chọn đã được xoá thành công.',
	'DRAFTS_EXPLAIN'			=> 'Với bảng điều khiển này, bạn có thể xem, sửa và xoá những bản nháp đã lưu của mình.',
	...
	'EXPORT_AS_XML'				=> 'Xuất ra định dạng XML',
	'EXPORT_AS_CSV'				=> 'Xuất ra định dạng CSV',
	'EXPORT_AS_CSV_EXCEL'		=> 'Xuất ra định dạng CSV (Excel)',
	'EXPORT_AS_TXT'				=> 'Xuất ra định dạng CSV TXT',
	...
	'FRIENDS'					=> 'Bạn thân',
	'FRIENDS_EXPLAIN'			=> 'Bạn thân là những thành viên đã được bạn thiết lập mặc định để có thể nhanh chóng liên lạc với họ hoặc liên lạc thường xuyên. Nếu giao diện bạn đang sử dụng trong hệ thống có hỗ trợ, bất kỳ bài viết nào được gửi bạn thân của bạn đều được đánh dấu nổi bật.',
	...
	'FULL_FOLDER_OPTION_CHANGED'=> 'Thiết lập thao tác xử lý mặc định khi thư mục đầy đã được cập nhật thành công.',
	...
	'INVALID_USER_BIRTHDAY'			=> 'Ngày sinh nhập vào không hợp lệ.',
	...
	'MESSAGES_DELETED'				=> 'Tin nhắn đã được xoá thành công.',
	...
	'NEW_EMAIL_CONFIRM_EMPTY'		=> 'Bạn chưa nhập Email xác nhận.',
	...
	'NOTIFY_METHOD_EXPLAIN'			=> 'Chọn phương pháp gửi tin nhắn từ website.',
	...
	'NOT_ADDED_FRIENDS_BOTS'		=> 'Bạn không thể thêm bot vào danh sách bạn bè.',
	...
	'NOT_ADDED_FOES_BOTS'			=> 'Bạn không thể thêm bot vào danh sách bạn.',
	...
	'NO_BOOKMARKS_SELECTED'		=> 'Bạn chưa chọn bất kỳ trang yêu thích nào.',
	...
	'NO_FRIENDS_ONLINE'			=> 'Không có bạn thân nào đang trực tuyến',
	...
	'NO_RULES_DEFINED'			=> 'Không có quy định cá nhân nào được xác định.',
	...
	'NO_WATCHED_SELECTED'		=> 'Bạn chưa chọn bất kỳ chủ đề đang theo dõi hay chuyên mục.',
	...
	'PASSWORD_UPDATED'			=> 'Mật khẩu mới của bạn đã được gửi đến địa chỉ Email hiện tại của bạn.',
	...
	'POST_PM_LOCKED'			=> 'Tin nhắn bị khoá',
	...
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM' => 'Bạn có chắc chắn muốn xoá những trang yêu thích đã chọn?',
	...
	'REPLY_TO_ALL'						=> 'Gửi trả lời tới người gửi và tất cả những người nhận.',
	'REPORT_PM'							=> 'Báo cáo tin nhắn riêng',
	'RESIGN_SELECTED'					=> 'Không tham gia nữa vào nhóm đã chọn',
	'RETURN_FOLDER'						=> '%1$sQuay về thư mục trước%2$s',
	'RETURN_UCP'						=> '%sQuay về bảng điều khiển của thành viên%s',
	'RULE_ADDED'						=> 'Quy định cá nhân đã được thêm vào thành công.',
	'RULE_ALREADY_DEFINED'				=> 'Quy định cá nhân này đã được xác định rồi.',
	'RULE_DELETED'						=> 'Quy định cá nhân đã được gỡ bỏ thành công.',
	...
	'UCP_PM_OPTIONS'			=> 'Quy định cá nhân và tùy chọn thư mục',
	...
	'UCP_WELCOME'							=> 'Chào mừng bạn đã đến với bảng điều khiển của thành viên. Với bảng điều khiển này, bạn có thể quản lý, xem và cập nhật thông tin cá nhân, thiết lập những sở thích cá nhân, theo dõi các chuyên mục và chủ đề mà mình quan tâm. Nếu được cấp phép, bạn cũng có thể gửi tin nhắn đến các thành viên khác. Hãy chắc chắn rằng bạn đã đọc qua các thông báo quan trọng nếu có trước khi tiếp tục.',
	'UCP_YIM'								=> 'Tài khoản Yahoo',
	'UCP_ZEBRA'								=> 'Bạn thân &amp; kẻ thù',
	'UCP_ZEBRA_FOES'						=> 'Quản lý kẻ thù',
	'UCP_ZEBRA_FRIENDS'						=> 'Quản lý bạn thân',
	'UNDISCLOSED_RECIPIENT'					=> 'Không kèm thông tin người nhận',
	...
	'WRONG_ACTIVATION'			=> 'Khóa kích hoạt bạn vừa cung cấp không phù hợp với bất kỳ tài khoản nào trong cơ sở dữ liệu.',
	...
	'GROUP_PENDING'		=> 'Là thành viên đang chờ quyết định của nhóm',
	'GROUP_NONMEMBER'	=> 'Không phải là thành viên của nhóm',
	'GROUP_DETAILS'		=> 'Thông tin chi tiết về nhóm',

	'NO_LEADER'		=> 'Không phải là người điều hành của nhóm',
