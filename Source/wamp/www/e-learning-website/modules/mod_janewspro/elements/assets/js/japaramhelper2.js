...
var JAPARAM2 = new Class({		
	...
	initialize: function(optionid) {
		...
		if($('paramsgroupbysubcat1')!=null){
			var disabled = false;
			if($('paramsgroupbysubcat1').checked){
				$('japaramsshowsubcattitle1').getParent().getParent().show('table-row');
				disabled = true;
			}
			else{
				$('japaramsshowsubcattitle1').getParent().getParent().hide();
			}
			
			/* Set show/hide for sub Joomla Category and sub K2 Category */
			this.hideChildren('paramscatsid', disabled);
			this.hideChildren('paramsk2catsid', disabled);
			this.hideChildren('paramsflexi_catsid', disabled);
			
			$('paramsgroupbysubcat1').addEvent('click', function(){
				this.hideChildren('paramscatsid', true);
				this.hideChildren('paramsk2catsid', true);
				this.hideChildren('paramsflexi_catsid', true);
				$('japaramsshowsubcattitle1').getParent().getParent().show('table-row');
			}.bind(this));	
			
			$('paramsgroupbysubcat0').addEvent('click', function(){
				this.hideChildren('paramscatsid', false);
				this.hideChildren('paramsk2catsid', false);
				this.hideChildren('paramsflexi_catsid', false);
				$('japaramsshowsubcattitle1').getParent().getParent().hide();
			}.bind(this));	
		...
		if($('paramssourceJAK2Helper').checked){
			$('japaramsshowcontentfrontpage1').getParent().getParent().hide();
			$('japaramsshowfeaturedItems1').getParent().getParent().show('table-row');
		}
		else{
			$('japaramsshowcontentfrontpage1').getParent().getParent().show('table-row');
			$('japaramsshowfeaturedItems1').getParent().getParent().hide();
		}
		$('paramssourceJAK2Helper').addEvent('click', function(){
			$('japaramsshowcontentfrontpage1').getParent().getParent().hide();
			$('japaramsshowfeaturedItems1').getParent().getParent().show('table-row');
		});	
		$('paramssourceJANewsHelper').addEvent('click', function(){
			$('japaramsshowfeaturedItems1').getParent().getParent().hide();
			$('japaramsshowcontentfrontpage1').getParent().getParent().show('table-row');
		});	
		$('paramssourceJAFlexiHelper').addEvent('click', function(){
			$('japaramsshowfeaturedItems1').getParent().getParent().hide();
			$('japaramsshowcontentfrontpage1').getParent().getParent().show('table-row');
		});
	},
