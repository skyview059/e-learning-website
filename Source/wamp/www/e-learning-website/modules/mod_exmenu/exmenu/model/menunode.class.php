<?php
/**
* @version $Id: menunode.class.php 517 2011-06-12 12:47:20Z  $
* @author Daniel Ecer
* @package exmenu
...
class MenuNode extends AbstractNode {
	...
	function getParentId() {
		return (isset($this->parent_id) ? $this->parent_id : (isset($this->parent) ? $this->parent : 0));
	}
	 ...
	 */
	function getAlias() {
		return (isset($this->alias) ? $this->alias : (isset($this->name) ? $this->name : ''));
	}
