	...
	<?php else: ?>
		...
		<tr>
			...
			<td>
				...
				$haveAccess = $this->checkAccess($extension->option,'site.block','users',$groupName);
				?>
				<input type="checkbox" <?php if( $haveAccess ): ?> checked="checked" <?php endif; ?> name="ada_access[<?php echo $extension->option; ?>][]" value="site.block" /> Block
			</td>
		</tr>
		<?php endforeach; ?>
	<?php endif; ?>
