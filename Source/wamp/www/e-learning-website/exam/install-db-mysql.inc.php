...
"INSERT INTO ".$srv_settings['table_prefix']."users (id, username, user_passhash, email, user_firstname, user_lastname, user_middlename, user_address, user_company, user_caddress, user_department, user_trainer, user_ufield1, user_ufield2, user_ufield3, user_ufield4, user_ufield5, user_ufield6, user_ufield7, user_ufield8, user_ufield9, user_ufield10, user_notes, user_joindate, user_logindate, user_expiredate, user_enabled) VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', ".($g_db->qstr($srv_settings['default_email'], get_magic_quotes_gpc())).", ".($g_db->qstr($lngstr['initdb_users_1_firstname'], get_magic_quotes_gpc())).", ".($g_db->qstr($lngstr['initdb_users_1_lastname'], get_magic_quotes_gpc())).", '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ".$i_now.", ".$i_now.", 0, 1);",
...
ADD user_title varchar(32) NOT NULL default '' AFTER email,
...
$i_queries_010910 = array (
	...
	'tests_own' => array(
"ALTER TABLE ".$srv_settings['table_prefix']."tests_own ADD test_own_expiredate int unsigned NOT NULL default '0' AFTER id;",
	),
