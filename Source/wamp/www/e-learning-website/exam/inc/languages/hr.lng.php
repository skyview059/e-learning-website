...
$lngstr['branding']['btm_sign'] = '<a target="_blank" href="/">Trang ch·ªß</a> 
| <a target="_blank" href="/diendan/">Di·ªÖn ƒë√†n</a> 
| <a target="_blank" href="/nhac/">Nghe nh·∫°c</a> 
| <a target="_blank" href="/soft/">Ph·∫ßn m·ªÅm</a> 
| <a target="_blank" href="/luubut/">L∆∞u b√∫t</a> 
| <a target="_blank" href="/uocnguyen/">∆Ø·ªõc nguy·ªán</a> 
| <a target="_blank" href="/tintuc/">Tin t·ª©c</a> 
| <a target="_blank" href="/tudien/">T·ª´ ƒëi·ªÉn</a>
<br>Copyright &copy; T√¢nPh√∫.Net 2008. All Rights Reserved.';
// Sign in page:
$lngstr['page_signin_box_intro'] = '';

// Non-customizable (it is not recommended to customize this data):
// ----------------------------------------------------------------
$lngstr['branding']['powered_by'] = 'Tr·∫Øc nghi·ªám T√¢n Ph√∫ v'.IGT_VERSION.'';
// General:
...
$lngstr['label_partially'] = 'DjelomiËno';
...
$lngstr['label_navigate_show'] = 'Prikaûi:';
...
$lngstr['button_first_page'] = 'PoËetna stranica';
$lngstr['button_last_page'] = 'Zadnja stranica';

$lngstr['label']['view_edit_user'] = 'Vidi / editiraj ovaj korisniËki profil';

$lngstr['label_atype_multiple_choice'] = 'Viöestruki izbor';
$lngstr['label_atype_multiple_answer'] = 'Viöe odgovora';
$lngstr['label_atype_truefalse'] = 'ToËno/NetoËno';
$lngstr['label_atype_truefalse_true'] = 'ToËno';
$lngstr['label_atype_truefalse_false'] = 'NetoËno';
$lngstr['label_atype_fillintheblank'] = 'Kratki odgovor';
$lngstr['label_atype_essay'] = 'Pisani odgovor';
$lngstr['label_atype_random'] = 'SluËajno pitanje';
...
$lngstr['page_title_panel'] = 'Rijeöi test';
$lngstr['page_header_panel'] = $lngstr['page_title_panel'];
$lngstr['page_title_test'] = 'Rijeöi test';
$lngstr['page_title_results'] = 'Upravljanje izvjeötajima';
$lngstr['page_header_results'] = $lngstr['page_title_results'];
 ...
 $lngstr['page_reportsmanager']['correct_answer'] = 'Pitanje s toËnim odgovorom';
 $lngstr['page_reportsmanager']['your_answer'] = 'Vaö odgovor';
$lngstr['page_statistics']['title'] = 'Statistike';
$lngstr['page_statistics']['header'] = $lngstr['page_statistics']['title'];
 $lngstr['page_statistics_resultid']['title'] = 'Detaljni izvjeötaj o testu';
 $lngstr['page_statistics_resultid']['header'] = 'Detaljni izvjeötaj testa za: %s';
...
$lngstr['page_header_edittests'] = $lngstr['page_title_edittests'];
 ...
 $lngstr['page_title_test_assignto'] = 'Pridruûi';
...
$lngstr['page_title_emailtemplates'] = 'Email predloöci';
$lngstr['page_header_emailtemplates'] = $lngstr['page_title_emailtemplates'];
 $lngstr['page_title_etemplates_edit'] = 'Editiraj email predloûak';
 $lngstr['page_header_etemplates_edit'] = $lngstr['page_title_etemplates_edit'];
$lngstr['page_title_rtemplates'] = 'Predloöci izvjeötaja';
$lngstr['page_header_rtemplates'] = $lngstr['page_title_rtemplates'];
 $lngstr['page_title_rtemplates_edit'] = 'Editiraj predloûak izvjeötaja';
...
$lngstr['label_accept_as_correct'] = 'Prihvati kao otoËan';
$lngstr['label_answer_percents'] = '% toËan';
$lngstr['label_mark_correct_answers'] = 'OznaËite toËan(e) odgovor(e)';
$lngstr['label_mark_correct_fillintheblank'] = 'Upiöite toËan odgovor ovdje';

// Report Manager:
$lngstr['label_hdr_action'] = 'MoguÊnosti';
...
$lngstr['label_action_test_result_delete'] = 'Izbriöi ovaj upis';
$lngstr['label_action_results_delete'] = 'Izbriöi rezultate (odabrane)';
...
$lngstr['label_action_test_delete'] = 'Izbriöi ovaj test';
$lngstr['label_action_tests_delete'] = 'Izbriöi testove (oznaËene)';
...
$lngstr['label_action_questions_append'] = 'Dodaj pitanja testu (oznaËena)';
$lngstr['label_action_question_delete'] = 'Izbriöi ovo pitanje';
$lngstr['label_action_questions_delete'] = 'Izbriöi pitanja (oznaËena)';
$lngstr['label_action_question_link_delete'] = 'Izbaci ovo pitanej iz testa';
$lngstr['label_action_question_links_delete'] = 'Izbaci pitanja iz testa (oznaËena)';
$lngstr['label_action_question_stats'] = 'Prikaûi statistike';
$lngstr['label_action_questions_stats'] = 'Prikaûi statistike (za oznaËene podatke)';
$lngstr['label_action_manageusers_edit'] = 'Postavke korisnika';
$lngstr['label_action_manageusers_groups'] = 'Grupe korisnika';
$lngstr['label_action_groups'] = 'Grupe korisnika (za oznaËene grupe)';
$lngstr['label_action_manageusers_delete'] = 'Izbriöi ovog korisnika';
$lngstr['label_action_users_delete'] = 'Izbriöi korisnike (oznaËene)';
$lngstr['label_action_create_user'] = 'Kreiraj novog korisnika';
$lngstr['label_action_group_delete'] = 'Izbriöi ovu grupu';
$lngstr['label_action_groups_delete'] = 'Izbriöi grupe (oznaËene)';
$lngstr['label_action_create_group'] = 'Kreiraj novu grupu';
$lngstr['label_action_group_edit'] = 'Postavke grupa';
$lngstr['label_action_test_groups_select'] = 'Pridruûi grupi';
$lngstr['label_action_subject_edit'] = 'Postavke naziva';
$lngstr['label_action_subject_delete'] = 'Izbriöi ovaj naziv';
$lngstr['label_action_subjects_delete'] = 'Izbriöi nazive (oznaËene)';
...
$lngstr['label_action_create_etemplate'] = 'Kreiraj novi email predloûak';
$lngstr['label_action_etemplates_edit'] = 'Edititiraj ovaj email predloûak';
$lngstr['label_action_etemplate_delete'] = 'Izbriöi ovaj email predloûak';
$lngstr['label_action_etemplates_delete'] = 'Izbriöi email predloöke (oznaËene)';
$lngstr['label_action_grade_settings'] = 'Postavke sistema ocjenjivanja';
$lngstr['label_action_grade_delete'] = 'Izbriöi ovaj sistem ocjenjivanja';
$lngstr['label_action_grades_delete'] = 'Izbriöi sisteme ocjenjivanja (oznaËene)';
$lngstr['label_action_gradescales_edit'] = 'Editiraj ovaj Raspon ocjena';
$lngstr['label_action_gradescales_delete'] = 'Izbriöi ocjene (oznaËene)';
$lngstr['label_action_gradescale_edit'] = 'Editiraj ovu ocjenu';
$lngstr['label_action_gradescale_delete'] = 'Izbriöi ovu ocjenu';
$lngstr['label_action_visitor_delete'] = 'Izbriöi ovaj podatak';
$lngstr['label_action_visitors_delete'] = 'Izbriöi podatke (oznaËene)';
$lngstr['page-sections']['action_section_create'] = 'Kreiraj';
$lngstr['page-sections']['action_section_edit'] = 'Editiraj ovu sekciju';
$lngstr['page-sections']['action_section_delete'] = 'Izbriöi ovu sekciju';
$lngstr['page-sections']['action_sections_delete'] = 'Izbriöi sekcije (oznaËene)';
$lngstr['page-rtemplates']['action_create_rtemplate'] = 'Kreiraj novi predloûak izvjeötaja';
$lngstr['page-rtemplates']['action_rtemplate_delete'] = 'Izbriöi ovaj predloûak izvjeötaja';
$lngstr['page-rtemplates']['action_rtemplates_delete'] = 'Izbriöi predloöke izveötaja (oznaËene)';
$lngstr['page-rtemplates']['action_rtemplates_edit'] = 'Editiraj ovaj predloûak izvjeötaja';
...
$lngstr['label_result_timespent'] = '<b>Utroöeno vrijeme:</b> %s';
$lngstr['label_result_got_answers'] = '<b>ToËnih odgvora:</b> %d out of %d';
$lngstr['label_result_got_points'] = '<b>Rezultat:</b> %d out of %d (%d%%)';
$lngstr['label_result_points_pending'] = '<b>MoguÊih bodova:</b> %d';
$lngstr['label_result_got_grade'] = '<b>Ocjena:</b> %s';
$lngstr['label_result_do_not_show'] = 'Vaö test je ocjenjen i upisan u bazu.';
$lngstr['label_result_showpdf'] = 'Kliknite ovdje za PDF izvjeötaj';
...
$lngstr['label_report_hdr_username'] = 'Korisnik';
$lngstr['label_report_hdr_username_hint'] = 'Korisnik (kliknite za sortiranje po)';
...
$lngstr['page_reportsmanager']['hdr_test_pokuöaja'] = 'Utroöenih pokuöaja';
$lngstr['page_reportsmanager']['hdr_test_pokuöaja_hint'] = 'Utroöenih pokuöaja';
$lngstr['label_report_hdr_result_timeexceeded'] = 'Utroöeno vremena';
$lngstr['label_report_hdr_result_timeexceeded_hint'] = 'Utroöeno vremena (kliknite za sortiranje po)';
...
$lngstr['label_report_hdr_result_pointsmax'] = 'MoguÊih bodova';
$lngstr['label_report_hdr_result_pointsmax_hint'] = 'MoguÊih bodova(kliknite za sortiranje po)';
...
$lngstr['label_edittests_hdr_test_datestart'] = 'Datum poËetka';
$lngstr['label_edittests_hdr_test_datestart_hint'] = 'Datum poËetka (kliknite za sortiranje po)';
$lngstr['label_edittests_hdr_test_dateend'] = 'Datum zavröetka';
$lngstr['label_edittests_hdr_test_dateend_hint'] = 'Datum zavröetka (kliknite za sortiranje po)';
$lngstr['label_edittests_hdr_test_notes'] = 'B';
$lngstr['label_edittests_hdr_test_notes_hint'] = 'Biljeöke';
...
$lngstr['label_manageusers_hdr_id'] = 'ID';
$lngstr['label_manageusers_hdr_id_hint'] = 'ID korisnika (kliknite za sortiranje po)';
$lngstr['label_manageusers_hdr_user_notes'] = 'B';
$lngstr['label_manageusers_hdr_user_notes_hint'] = 'Biljeöke';
$lngstr['label_manageusers_hdr_username'] = 'Korisnik';
$lngstr['label_manageusers_hdr_username_hint'] = 'Korisnik (kliknite za sortiranje po)';
$lngstr['label_manageusers_hdr_email'] = 'Email';
$lngstr['label_manageusers_hdr_email_hint'] = 'Email (kliknite za sortiranje po)';
...
$lngstr['label_etemplates_hdr_etemplateid_hint'] = 'ID email predloöka (kliknite za sortiranje po)';
$lngstr['label_etemplates_hdr_etemplate_name'] = 'Naziv';
$lngstr['label_etemplates_hdr_etemplate_name_hint'] = 'Nasziv email predloöka (kliknite za sortiranje po)';
$lngstr['label_etemplates_hdr_etemplate_description'] = 'Opis';
$lngstr['label_etemplates_hdr_etemplate_description_hint'] = 'Opis email predloöka (kliknite za sortiranje po)';

$lngstr['page-rtemplates']['hdr_rtemplateid'] = 'ID';
$lngstr['page-rtemplates']['hdr_rtemplateid_hint'] = 'ID predloöka izvjeötaja (kliknite za sortiranje po)';
$lngstr['page-rtemplates']['hdr_rtemplate_name'] = 'Naziv';
$lngstr['page-rtemplates']['hdr_rtemplate_name_hint'] = 'Naziv predloöka izvjeötaja (kliknite za sortiranje po)';
$lngstr['page-rtemplates']['hdr_rtemplate_description'] = 'Opis';
$lngstr['page-rtemplates']['hdr_rtemplate_description_hint'] = 'Opis predloöka izvjeötaja (kliknite za sortiranje po)';
...
$lngstr['button_submit'] = 'Poöalji';
$lngstr['button_update'] = 'Osvjeûi';
$lngstr['button_update_and_edit_questions'] = 'Osvjeûi / Idi na listu pitanja';
$lngstr['button_update_and_create_new_question'] = 'Osvjeûi / kreiraj novo pitanje';
...
$lngstr['label_state'] = 'Drûava:';
$lngstr['label_zip'] = 'Poötanski broj:';
$lngstr['label_country'] = 'Drûava:';
...
$lngstr['label_gender_items'] = array(0 => $lngstr['label_pleasespecify'], 1 => 'Muöko', 2 => 'éensko');
...
$lngstr['page_register']['no_username'] = 'Neispravano polje korisniËko ime.<br>';
...
$lngstr['page_register']['no_state'] = 'Neispravano polje drûava.<br>';
$lngstr['page_register']['no_zip'] = 'Neispravano polje poötanski broj.<br>';
$lngstr['page_register']['no_country'] = 'Neispravano polje drûava.<br>';
...
$lngstr['page_register']['no_cstate'] = 'Neispravano polje Drûava tvrtke.<br>';
$lngstr['page_register']['no_czip'] = 'Neispravano polje poötanski broj.<br>';
$lngstr['page_register']['no_ccountry'] = 'Neispravano polje drûave tvrtke.<br>';
...
$lngstr['err_username_duplicate'] = 'Ovo korisniËko ime se veÊ koristi. Izaberite neko drugo.<br>';
$lngstr['err_groupname_duplicate'] = 'Ovaj naziv za grupu se veÊ koristi. Izaberite neki drugi.<br>';
$lngstr['err_subjectname_duplicate'] = 'Naziv teme se veÊ koristi. Izaberite neki drugi.<br>';
$lngstr['err_signin_incorrect']  = 'Nemoûete se ulogirati. KorisniËko ime i lozinka su neispravni.<br>';

// Register page:
$lngstr['page-register']['intro'] = 'Moûete korsititi ovu formu za dodavanje korisniËkog raËuna.';
$lngstr['page-register']['successful'] = 'Korisnik "%s" je uspjeöno dodan.';
$lngstr['page-register']['check_activation_email'] = 'Email je sposlan na vaöu adresu. Sadûi upute za zavröetak registracije.';
$lngstr['page-register']['account_activated'] = 'Vaö korisniËki raËun je aktiviran.';
$lngstr['page-register']['title_items'] = array('' => $lngstr['label_none'], 'Dr.' => 'Dr.', 'Miss' => 'Miss', 'Mr.' => 'Mr.', 'Mrs.' => 'Mrs.', 'Ms.' => 'Ms.', 'Prof.' => 'Prof.', 'Rev.' => 'Rev.');
$lngstr['page_register']['required_mark'] = REQUIRED_FIELD_MARK.' = OznaËava obavezna polja';
...
$lngstr['page_signin_box_register_intro'] = '<b>Nema korisniËki raËun?</b> Moûete se registrirati <a href="register.php">klikom na ovaj link</a>.';
$lngstr['page_signin_box_lostpassword_intro'] = '<b>Zaboravili ste lozinku?</b> Ako ste <a href="lostpassword.php">zaboravili lozinku</a>, poslat Êemo vam novu.';

// Forgot password page:
$lngstr['page_lostpassword_enter_username'] = '<b>Unesite vaöe korisniËko ime</b>';
$lngstr['button_send_new_password'] = 'Poöaljite novu lozinku';
$lngstr['err_username_not_found'] = 'KorisniËko ime nije pronaeno! Pokuöajte ponovo.';
$lngstr['inf_password_reset'] = 'Vaöa lozinka je resetirana! Provjerite email.';
...
$lngstr['page_panel_hdr_gettest'] = 'Rijeöi Test';
$lngstr['page_panel_hdr_gettest_hint'] = 'Rijeöi test';
$lngstr['page_panel_status_available'] = 'Dostupan';
$lngstr['page_panel_status_will_be_available_on'] = 'Bit Êe dostupan za <br>%s';
$lngstr['page_panel_get_test_link'] = 'Test';
$lngstr['page-takeatest']['attempts_left'] = 'Dostöan<br>(dopuöteno pokuöaja: %d)';
$lngstr['page-takeatest']['attempts_limit_reached'] = 'Nije dostupan<br>(pokuöaja allowed: 0)';
$lngstr['page-takeatest']['passed'] = 'Zavöen';
$lngstr['page_test_results'] = 'Rezultati testa';
$lngstr['page_test_results_homepage'] = 'Povratak na RIJEäI TEST stranicu';
$lngstr['page_test_results_viewresults'] = 'Pregledajte rezultate testa';
$lngstr['page_test']['results_nexttest'] = 'Nastavi';

$lngstr['page_results_delete_record'] = 'Izbriöi podatak';
$lngstr['page_edittests_delete_test'] = 'Izbriöi test';
$lngstr['page_edittests_delete_question'] = 'Izbriöi pitanje';
$lngstr['page_edittests_delete_question_link'] = 'Izbriöi pitanje';
$lngstr['page_managegroups_delete_group'] = 'Izbriöi grupu';
$lngstr['page_subjects_delete_subject'] = 'Izbriöi temu';
$lngstr['page_manageusers_delete_user'] = 'Izbriöi korisnika';
$lngstr['page_etemplates_delete_etemplate'] = 'Izbriöi email predloûak';
$lngstr['page-rtemplates']['delete_rtemplate'] = 'Izbriöi predloûak izvjeötaja';
$lngstr['page_grades_delete_grade'] = 'Izbriöi sistem ocjena';
$lngstr['page_gradescales_delete_grade'] = 'Izbriöi ocjenu';
$lngstr['page_visitors_delete_visitor'] = 'Izbriöi podatak';
...
$lngstr['page_edittests_teststart'] = 'Datum poËetka testa:';
$lngstr['page_edittests_testend'] = 'Datum zavröetka testa:';
$lngstr['page_edittests_testtime'] = 'Vrijeme testa:';
$lngstr['page_edittests_testtimeforceout'] = 'Zavröi ovaj test kad je limit testa prekoraËen';
$lngstr['page-testmanager']['attempts_allowed'] = 'Dopuöteno pokuöaja:';
$lngstr['page-testmanager']['attempts_allowed_list'] = array(0 => 'NeograniËeno', 1 => '1 attempt', 2 => '2 pokuöaja', 3 => '3 pokuöaja', 4 => '4 pokuöaja', 5 => '5 pokuöaja', 6 => '6 pokuöaja', 7 => '7 pokuöaja', 8 => '8 pokuöaja', 9 => '9 pokuöaja', 10 => '10 pokuöaja', 11 => '11 pokuöaja', 12 => '12 pokuöaja', 13 => '13 pokuöaja', 14 => '14 pokuöaja', 15 => '15 pokuöaja', 16 => '16 pokuöaja', 17 => '17 pokuöaja', 18 => '18 pokuöaja', 19 => '19 pokuöaja', 20 => '20 pokuöaja');
$lngstr['page_edittests_showquestions'] = 'Prikaûi pitanja:';
...
$lngstr['page_edittests_resultsettings'] = 'Izvjeötaj rezultata testa:';
$lngstr['page_edittests_result_showqfeedback'] = 'Prikaûi povratnu informaciju';
$lngstr['page_edittests_result_showgrade'] = 'Prikaûi ocjenu';
$lngstr['page_edittests_result_showanswers'] = 'Prikaûi odgvore';
$lngstr['page_edittests_result_showpoints'] = 'Prikaûi bodove';
$lngstr['page_testsettings']['custom_report'] = 'Koristi prilagoene predloöke:';
$lngstr['page_edittests_testdescription'] = 'Kratki opis:';
$lngstr['page_edittests_testinstructions'] = 'Upute za test:';
$lngstr['page_edittests_testnotes'] = 'Biljeöke za test (interne biljeöke):';
$lngstr['page_edittests_assignedto'] = 'Pridruûeno:';
// $lngstr['page_edittests_assignedto_everybody'] = 'Svi';
// $lngstr['page_edittests_assignedto_nobody'] = 'Nitko';
$lngstr['page_edittests_assignto_everybody'] = 'Pridruûeno svima (nadilazi sve postavke)';
$lngstr['page_edittests_advancedreport'] = 'Napredni izvjeötaj:';
// $lngstr['page-testsettings']['no_report'] = 'Nema izvjeötaja';
$lngstr['page-testsettings']['report_template'] = 'Predloûak:';
$lngstr['page-testsettings']['report_grade_condition'] = 'Uvijeti ocjena:';
$lngstr['page-testsettings']['no_condition'] = 'Nema uvijeta';
// $lngstr['label_no_advanced_report'] = 'Nema naprednih izvjeötaja';
$lngstr['page_edittests_advancedreport_showpdf'] = 'Prikaûi PDF izvjeötaj za printanje';
$lngstr['page_edittests_sendresultsbyemail'] = 'Poöalji rezultate na email:';
$lngstr['page_edittests_sendresultsbyemail_template'] = 'Predloûak:';
$lngstr['page_edittests_sendresultsbyemail_to'] = 'Email:';
$lngstr['page_edittests_result_emailtouser'] = 'poöalji rezultate korisnicima';
$lngstr['label_do_not_send_email'] = 'Ne öalji';
...
$lngstr['page_assignto_hdr_assignto'] = 'Pridruûen';
$lngstr['page_assignto_hdr_assignto_hint'] = 'Pridruûen';
...
$lngstr['page_importtest_ut_import_document_howto'] = '1. Pokrenite Editor module  UniTest Systema;<br>2. OznaËite Import Dokument iz File -> Export menu;<br>3. Kopiraj (koristeÊi clipboard) i zalijepi u ovaj text box.';
$lngstr['page_testmanager_import']['section_delimiters'] = 'Prefixes (klikni prikaûi/sakri)';
...
$lngstr['page_testmanager_import']['postq_delimiter'] = 'Obajaönjenje pitanja prefix:';
...
$lngstr['page_testmanager_stats']['test_high_score'] = 'NajveÊi rezultat testa:';
...
$lngstr['page_testmanager_stats']['hdr_subject_questions'] = 'VeliËina';
$lngstr['page_testmanager_stats']['hdr_subject_questions_hint'] = 'VeliËina skupe';
...
$lngstr['page_grade']['section_advanced'] = 'napredno (klikni za  prikaûi/sakri)';
...
$lngstr['page_questionstats_partially_count'] = 'DjelomiËno ispravnih odgovora:';
...
$lngstr['page_editquestion_emptyquestion'] = '<p><strong>Upiöite vaöe pitanje ovdje...</strong></p>';

$lngstr['label_action_visitors_view'] = 'Vidi detalje za ovaj podatak';
$lngstr['page_visitordetails_visitorid'] = 'ID posjetitelja:';
$lngstr['page_visitordetails_startdate'] = 'Datum poËetka:';
$lngstr['page_visitordetails_enddate'] = 'Datum zavröetka:';
$lngstr['page_visitordetails_timespent'] = 'Utroöeno vrijeme:';
...
$lngstr['page_visitordetails_useragent'] = 'KorisniËki preglednik:';

$lngstr['page_config']['section_site'] = 'Web stranice (klikni za prikaûi/sakri)';
...
$lngstr['page_config']['list_length'] = 'Duûina liste:';
$lngstr['page_config']['store_logs'] = 'Web statistike:';
$lngstr['page_config']['section_registration'] = 'Registracija (klikni za prikaûi/sakri)';
$lngstr['page_config']['can_register'] = 'Dopusti registraciju korisnika:';
$lngstr['page_config']['upon_registration'] = 'Kod registracije:';
$lngstr['page_config']['upon_registration_select'] = array(0 => 'Aktiviraj', 1 => 'Aktiviraj, logiraj automatski', 2 => 'Nemoj aktivirat, poöalji aktivacijski link emailom', 3 => 'Ne aktiviraj, koristi prilagoenu shemu (pr. naplata)');
...
$lngstr['page_config']['show_donotrequire'] = 'Prikaûi, ne obavezuj';
$lngstr['page_config']['show_autogenerate'] = 'Prikaûi, auto generiraj';
$lngstr['page_config']['show_require'] = 'Prikaûi, obaveûi';
...
$lngstr['page_users']['section_personal'] = 'Osobne informacije (klikni za prikaûi/sakrij)';
$lngstr['page_users']['section_work'] = 'Poslovne informacije (klikni za prikaûi/sakrij)';
$lngstr['page_users']['section_additional'] = 'Dodatne informacije (klikni za prikaûi/sakrij)';
...
$lngstr['page_users']['section_notes'] = 'Biljeöke (click to show/hide)';
$lngstr['page_users']['notes'] = 'KorisniËke biljöke (za internu upotrebu):';
...
$lngstr['page_groups_access_tests_select'] = array(0 => "Pristup zabranjen", 1 => "Vidi listu testova", 2 => "Rijeöava");
$lngstr['page_groups_access_testmanager'] = 'UpravljaË testovima:';
$lngstr['page_groups_access_testmanager_select'] = array(0 => "Pristup zabranjen", 1 => "»ita", 2 => "Piöe");
...
$lngstr['page_etemplates_etemplateid'] = 'ID Predloöka:';
$lngstr['page_etemplates_etemplatename'] = 'Naziv predloöka:';
$lngstr['page_etemplates_etemplatedescription'] = 'Opis predloöka:';
...
$lngstr['page_etemplates_template_tags'] = 'Tagovi predloöka';

$lngstr['page-rtemplates']['rtemplateid'] = 'ID Predloöka:';
$lngstr['page-rtemplates']['rtemplatename'] = 'Naziv predloöka:';
$lngstr['page-rtemplates']['rtemplatedescription'] = 'Opis predloöka:';
$lngstr['page-rtemplates']['rtemplatebody'] = 'Tijelo izvjeötaja:';
...
$lngstr['err_no_questions_left_in_bank'] = 'Broj razliËitih pitanja potrebnih je veÊi nego ova tema sadrûava.<br>';
$lngstr['err_no_tests'] = 'Trenutno nema testova dostupnih za rijeöavanje.<br>';
$lngstr['inf_cant_passtest'] = 'Nemate dovoljna prava da bi rijeöavali ovaj test.<br>';
...
$lngstr['inf_cant_access_emailtemplates'] = 'Nemate dovoljno prava da bi pristupili email predloöcima.<br>';
$lngstr['inf_cant_access_reporttemplates'] = 'Nemate dovoljno prava da bi pristupili predloöcima izvjeötaja.<br>';
...
$lngstr['err_no_test_selected'] = 'Molimo oznaËite test prvo.<br>';
$lngstr['err_no_question_n_in_db'] = 'Pitanje %d nemoûemo pronaÊi.<br>';
$lngstr['err_no_question_id_in_db'] = 'ID pitanja %d nemoûemo pronaÊi.<br>';
...
$lngstr['err_no_permissions_to_register'] = 'Nemate moguÊnosti registrirati nove korisnike';

$lngstr['qst_delete_test'] = 'Jeste li sigurni da ûelite izbrisati ovaj test?';
$lngstr['qst_delete_tests'] = 'Jeste li sigurni da ûelite izbrisati oznaËene testove?';
$lngstr['qst_delete_question'] = 'Jeste li sigurni da ûelite izbrisati ovo pitanje?';
$lngstr['qst_delete_questions'] = 'Jeste li sigurni da ûelite izbrisati oznaËena pitanja?';
$lngstr['qst_delete_question_link'] = 'Jeste li sigurni da ûelite izbaciti ovo pitanje iz testa?';
$lngstr['qst_delete_question_links'] = 'Jeste li sigurni da ûelite izbaciti ova pitanja iz testa?';
$lngstr['qst_delete_record'] = 'Jeste li sigurni da ûelite izbrisati ovaj podatak?';
$lngstr['qst_delete_records'] = 'Jeste li sigurni da ûelite izbrisati oznaËene podatke?';
$lngstr['qst_delete_user'] = 'Jeste li sigurni da ûelite izbrisati ovog korisnika?';
$lngstr['qst_delete_users'] = 'Jeste li sigurni da ûelite izbrisati oznaËene korisnike?';
$lngstr['qst_delete_group'] = 'Jeste li sigurni da ûelite izbrisati ovu grupu?';
$lngstr['qst_delete_groups'] = 'Jeste li sigurni da ûelite izbrisati oznaËene grupe?';
$lngstr['qst_delete_subject'] = 'Jeste li sigurni da ûelite izbrisati ovu temu?';
$lngstr['qst_delete_subjects'] = 'Jeste li sigurni da ûelite izbrisati oznaËene teme?';
$lngstr['qst_delete_etemplate'] = 'Jeste li sigurni da ûelite izbrisati ovaj email predloûak?';
$lngstr['qst_delete_etemplates'] = 'Jeste li sigurni da ûelite izbrisati oznaËene email predloöke?';
$lngstr['qst_delete_grade'] = 'Jeste li sigurni da ûelite izbrisati ovaj sistem ocjenjivanja?';
$lngstr['qst_delete_grades'] = 'Jeste li sigurni da ûelite izbrisati oznaËene sisteme ocjenjivanja?';
$lngstr['qst_delete_gradescale'] = 'Jeste li sigurni da ûelite izbrisati ovu ocjenu?';
$lngstr['qst_delete_gradescales'] = 'Jeste li sigurni da ûelite izbrisati oznaËene ocjene?';
$lngstr['qst_delete_visitor'] = $lngstr['qst_delete_record'];
$lngstr['qst_delete_visitors'] = $lngstr['qst_delete_records'];
$lngstr['page-sections']['qst_section_delete'] = 'Jeste li sigurni da ûelite izbrisati ovu sekciju?';
$lngstr['page-sections']['qst_sections_delete'] = 'Jeste li sigurni da ûelite izbrisati oznaËene sekcije?';
$lngstr['page-rtemplates']['qst_rtemplate_delete'] = 'Jeste li sigurni da ûelite izbrisati ovaj predloûak izvjeötaja?';
$lngstr['page-rtemplates']['qst_rtemplates_delete'] = 'Jeste li sigurni da ûelite izbrisati oznaËene predloöke izvjeötaja?';
...
$lngstr['install_page2_description'] = '<p><b>Naziv web stranica:</b> Upiöite nazvi web stranica.
<p><b>Glavni email:</b> OznaËite zadanu email adresu "From" za email poruke.
<p><b>iGiveTest URL:</b> Upiöite web adresu za iGiveTest.
<p><b>iGiveTest direktorij:</b> Upiöite punu stazu direktorija za ovu instalaciju.
<p><b>iGiveTest URL dokumenata:</b> Upiöite web adresu gdje Êe biti omoguÊen prsstup transferiranim dokumentima.
<p><b>iGiveTest direktorij dokumenata:</b> Upiöite punu stazu direktorija  gdje iGiveTest moûe snimiti transferirane dokumente. Ovaj direktorij mora biti sa  read i write permisijama za korisnika web servera (inaËe "nobody" ili "apache").';
...
$lngstr['install_page3_description'] = '<p>Konfigurirajte bazu podataka gdje iGiveTest Êe biti spremljeni. Baza podataka mora biti unaprijed kreirana i korisniËko ime i lozinka za pristup istoj.';
$lngstr['install_dbdriver'] = 'Tip baz epodataka:';
$lngstr['install_dbhost'] = 'Posluûitelj baze podataka:';
...
$lngstr['install_canwritetoconfig'] = '<p>config.inc.php je uspjeöno kreiran.';
$lngstr['install_page4'] = 'Instalacija je zavröena';
...
$lngstr['initdb_etemplates_1_description'] = 'Email predloûak rezultata testa (zadano)';
$lngstr['initdb_etemplates_1_subject'] = 'iGiveTest - Primjer izvjeötaja';
$lngstr['initdb_etemplates_1_body'] = 'Poötovanje [USER_FIRST_NAME],

Ovdje su rezultati vaöeg testa:

Naziv testa: [TEST_NAME]
Datum: [RESULT_DATE]
Vrijeme utroöeno: [RESULT_TIME_SPENT]
Vrijeme prekoraËeno: [RESULT_TIME_EXCEEDED]
...
$lngstr['initdb_etemplates_2_description'] = 'Email predloûak registracije korisnika';
$lngstr['initdb_etemplates_2_subject'] = 'Detalji registracije';
$lngstr['initdb_etemplates_2_body'] = 'Poötovanje [USER_FIRST_NAME],

Hvala vam za registraciju sa iGiveTest.

KorisniËko ime: [USERNAME]
Lozinka: [USER_PASSWORD]

Moûete se logirati kad god ûelite ako posjetite:
...
$lngstr['initdb_etemplates_3_description'] = 'Email predloûak registracije korisnika';
$lngstr['initdb_etemplates_3_subject'] = 'Detalji registracije';
$lngstr['initdb_etemplates_3_body'] = 'Poötovanje [USER_FIRST_NAME],
...
Joö samo jedan korak:

Da bi zavröili aktivaciju vaöeg raËuna, kliknite slijedeÊi link:

[IGIVETEST_URL]/account.php?action=activate&id=[USER_ID]&checkword=[USER_CHECKWORD]

Pozdrav,
iGiveTest Team';

$lngstr['initdb_etemplates_4_name'] = 'RaËun aktiviran';
$lngstr['initdb_etemplates_4_description'] = 'Email predloûak aktivacije raËuna';
$lngstr['initdb_etemplates_4_subject'] = 'RaËun aktiviran';
$lngstr['initdb_etemplates_4_body'] = 'Poötovanje [USER_FIRST_NAME],

Vaö raËun je uspjeöno aktiviran.
...
$lngstr['initdb_etemplates_50_description'] = 'Email predloûak obnavljanja lozinke';
$lngstr['initdb_etemplates_50_subject'] = 'iGiveTest - Obnavljanje lozinke';
$lngstr['initdb_etemplates_50_body'] = 'Poötovanje [USER_FIRST_NAME],

Resetirali smo vaöu lozinku.
...
$lngstr['initdb_gscales_2_name'] = 'Proöao/Nije proöao Raspon ocjena';
$lngstr['initdb_gscales_3_name'] = 'ECTS Raspon ocjena';
$lngstr['initdb_gscales_4_name'] = 'GPA Raspon ocjena';
$lngstr['initdb_gscales_5_name'] = '6-bodova Raspon ocjena (NjemaËka)';
$lngstr['initdb_gscales_6_name'] = '5-bodova Raspon ocjena (Centralna i istoËna europa)';
$lngstr['initdb_gscales_1_description'] = 'A-F Raspon ocjena';
$lngstr['initdb_gscales_2_description'] = 'Proöao/Nije proöao Raspon ocjena';
...
$lngstr['initdb_gscales_5_description'] = '6-bodova Raspon ocjena u NjemaËkoj';
$lngstr['initdb_gscales_6_description'] = '5-bodova Raspon ocjena u centralnoj i istoËnoj europi';
$lngstr['initdb_gscales_1_1_description'] = 'Izvrsno';
$lngstr['initdb_gscales_1_2_description'] = 'Dobro';
$lngstr['initdb_gscales_1_3_description'] = 'Poöetno';
$lngstr['initdb_gscales_1_4_description'] = 'Loöe';
$lngstr['initdb_gscales_1_5_description'] = 'Nedovoljno';
$lngstr['initdb_gscales_2_1_name'] = 'Proöao';
$lngstr['initdb_gscales_2_2_name'] = 'Nije proöao';
$lngstr['initdb_gscales_2_1_description'] = 'Proöao';
$lngstr['initdb_gscales_2_2_description'] = 'Niej proöao';
$lngstr['initdb_gscales_3_1_description'] = 'Izvrsno (samo manje pogreöke)';
$lngstr['initdb_gscales_3_2_description'] = 'Vrlo dobro (iznad prosjeËnog sa nekim greökama)';
$lngstr['initdb_gscales_3_3_description'] = 'Dobro (OK sa malo veÊih greöaka)';
$lngstr['initdb_gscales_3_4_description'] = 'ZadovoljavajuÊe (dobro sa nekoliko veÊih propusta )';
$lngstr['initdb_gscales_3_5_description'] = 'Dovoljno (minimum kriterija)';
$lngstr['initdb_gscales_3_6_description'] = 'Nedovoljno (joö malo rada je potrebno za prolaznu ocjenu)';
$lngstr['initdb_gscales_3_7_description'] = 'Nedovljno (popriliËno rada je joö potrebno)';
$lngstr['initdb_gscales_4_1_description'] = 'Izvrsno';
$lngstr['initdb_gscales_4_2_description'] = 'Dobro';
$lngstr['initdb_gscales_4_3_description'] = 'Poöteno';
$lngstr['initdb_gscales_4_4_description'] = 'Loöe';
...
$lngstr['initdb_gscales_5_3_description'] = 'ZadovoljavajuÊe';
$lngstr['initdb_gscales_5_4_description'] = 'Dovoljno';
$lngstr['initdb_gscales_5_5_description'] = 'NezadovoljavajuÊe';
$lngstr['initdb_gscales_5_6_description'] = 'Loöe';
$lngstr['initdb_gscales_6_1_description'] = 'Izvrsno';
$lngstr['initdb_gscales_6_2_description'] = 'Dobro';
$lngstr['initdb_gscales_6_3_description'] = 'ZadovoljavajuÊe';
$lngstr['initdb_gscales_6_4_description'] = 'NezadovoljavajuÊe';
$lngstr['initdb_gscales_6_5_description'] = 'Loûe';
...
$lngstr['initdb_groups_1_description'] = 'Aministratori imaju potpun i neograniËen pristup';
$lngstr['initdb_groups_2_description'] = 'Instruktori imaju veÊinu administratorski postavki sa nekim limitima';
$lngstr['initdb_groups_3_description'] = '»lanovi u ovoj grupu imaju moguÊnost kreiranja / Editiranja pitanja';
$lngstr['initdb_groups_19_description'] = 'Korisnici nemogu sluËajno ili namjerno napraviti neke promjene)';
$lngstr['initdb_groups_20_description'] = 'Gosti imaju ista prava kao i korisnici';
$lngstr['initdb_rtemplates_1_name'] = 'Predloûak izvjeötaja #1';
$lngstr['initdb_rtemplates_1_description'] = 'Predloûak izvjeötaja #1';
...
<strong>Utroöno vrijeme:</strong> [RESULT_TIME_SPENT]<br>
...
$lngstr['initdb_instructions'] = 'Koristite korisniËko ime "<strong>admin</strong>" i lozinku "<strong>admin</strong>" za ulaz.<br><strong>Zapamtite:</strong> preporuËamo mjenjanje lozinke.';
$lngstr['initdb_gotohomepage'] = 'Idi na poËetnu stranicu';

// Tooltips:
$lngstr['tooltip_button'] = 'Prikaûi/sakri traku za pomoÊ';
$lngstr['tooltip_showbar'] = 'Prikaûi traku za pomoÊ';
$lngstr['tooltip_closebar'] = 'Sakri traku za pomoÊ';
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-groups.gif" title="'.$lngstr['label_action_test_groups_select'].'"></td><td class=rowone width="100%" colspan=4>Za pridruûivanje testova odreenoj grupi korisnika, kliknite gumb desno od  testa ili oznaËite sve potrebne testove koriteÊi zastavice lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_test_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje testova, kliknite gumb desno od testa ili oznaËite sve potrebne testove koriteÊi zastavice lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_grade_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje sistema ocjena, kliknite gumb desno od sistema ocjena ili oznaËite sistem ocjena koriteÊi zastavice lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_gradescale_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje ocjena, kliknite gumb desno od ocjena ili oznaËite ocjene koristeÊi zastavice na lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
$lngstr['tooltip_etemplates'] = '<p>Ova stranica namjenjena je za kreiranje i editiranje email predloûaka.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_etemplate'].'"></td><td class=rowone width="100%" colspan=4>Za kreiranje novog email predloöka, kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_etemplates_edit'].'"></td><td class=rowone width="100%" colspan=4>Za editiranje email predloöka, kliknite gumb desno od of the email template.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_etemplate_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje email preedloûaka, kliknite gumb desno od email predloûka ili oznaËi sve email poruke koristeÊi zastavice na lijevo kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
$lngstr['tooltip_rtemplates'] = '<p>Ova stranica namjenjena je za kreiranje i editiranje predloûaka izvjeötaja.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['page-rtemplates']['action_create_rtemplate'].'"></td><td class=rowone width="100%" colspan=4>Za kreiranje novog predloöka izvjeöta, kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['page-rtemplates']['action_rtemplates_edit'].'"></td><td class=rowone width="100%" colspan=4>Za editiranje predloöka izvjeötaja, kliknite gumb desno od of the report template.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['page-rtemplates']['action_rtemplate_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje predloûaka izvjeötaja, kliknite gumb desno od predloûaka izvjeötaja ili oznaËite predloöke izvjeötaja koristeÊi zastavice na lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-import.gif" title="'.$lngstr['label_action_import_questions'].'"></td><td class=rowone width="100%" colspan=4>Za importiranje pitanaj u test, kliknite slijedeÊi gumb nha alatnoj traci pri vrhu.</td></tr>
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_question_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje pitanja, kliknite gumb desno od pitanja ili oznaËite sva pitanja koristeÊi zastavice na lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['page-sections']['action_section_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje sekcija, kliknite gumb desno os sekcije ili oznaËite sekcije koristeÊi zastavice na lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
$lngstr['tooltip_tests_groups'] = '<p>Ova stranica namjenjena je za pridruûivanje testova odreenoj grupi korisnika.</p>
<p>Tablica testova:</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-gear.gif" title="'.$lngstr['label_action_test_settings'].'"></td><td class=rowone width="100%" colspan=4>Za promjenu postavki testa, kliknite gumb desno od testa.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-groups.gif" title="'.$lngstr['label_action_test_groups_select'].'"></td><td class=rowone width="100%" colspan=4>Za pridruûivanje test(s) to certain groups of users, kliknite gumb desno od of the test or select all necessary tests using the flag marks on the left and kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_questions_edit'].'"></td><td class=rowone width="100%" colspan=4>Za editiranje pitanja testa, kliknite gumb desno od testa.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_test_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje testova, kliknite gumb desno od testa ili oznaËite potrebne testove koristeÊi zastavice na lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>
<p>Tablica grupa:</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_subject_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje Tema, kliknite gumb desno od teme ili oznaËite teme koristeÊi zastavice na lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_test_result_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje podataka, kliknite gumb desno od podatka ili oznaËite podatke koristeÊi zastavic ena lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
$lngstr['tooltip_users'] = '<p>Ova stranica namjenjena je za kreiranje i editiranje korisniËkih raËuna.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_user'].'"></td><td class=rowone width="100%" colspan=4>Za kreiranje novog korisniËkog raËuna, kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-groups.gif" title="'.$lngstr['label_action_manageusers_groups'].'"></td><td class=rowone width="100%" colspan=4>Za pridruûivanje korisnika odreenoj grupi, kliknite gumb desno od korisnika ili oznaËite korisnike koristeÊi zastavice i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_manageusers_edit'].'"></td><td class=rowone width="100%" colspan=4>Za editiranje korisniËkog raËuna, kliknite gumb desno od korisniËkog raËuna.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_manageusers_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje korisniËkih raËuna, kliknite gumb desno od raËuna korisnika ili oznaËite korisnike koristeÊi zastavice na lijevo i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
...
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_group'].'"></td><td class=rowone width="100%" colspan=4>Za kreiranje nove grupe, kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_group_edit'].'"></td><td class=rowone width="100%" colspan=4>Za editiranje grupe, kliknite gumb desno od grupe.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_group_delete'].'"></td><td class=rowone width="100%" colspan=4>Za brisanje grupa, kliknite gumb desno od grupe ili oznaËite grupe koriteÊi zastavice i kliknite gumb na alatnoj traci pri vrhu.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Koristite ove gumbove za navigaciju izmeu stranica.</td></tr>
</table></p>';
