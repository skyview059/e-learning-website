...
$lngstr['label_none'] = '- Không có đề tài (Trống) -';
...
$lngstr['page_header_questionbank'] = $lngstr['page_title_questionbank'];
 ...
 $lngstr['page_title_edit_question'] = 'Tạo / Sửa câu hỏi';
...
$lngstr['label_choice_no'] = 'Đáp án %d:';
$lngstr['label_answer_text'] = 'Trả lời:';
$lngstr['label_answer_feedback_no'] = 'Phản hồi %d:';
$lngstr['label_accept_as_correct'] = 'Chọn đáp án đúng';
...
// Report Manager:
$lngstr['label_hdr_action'] = 'Activities';
...
$lngstr['label_report_hdr_username'] = 'Username';
$lngstr['label_report_hdr_username_hint'] = 'Username (Bấm để sắp xếp)';
...
$lngstr['label_edittests_hdr_subjectid'] = 'Subjtect';
...
$lngstr['label_edittests_hdr_test_enabled'] = 'Activities';
$lngstr['label_edittests_hdr_test_enabled_hint'] = 'Activities (Bấm để sắp xếp)';
$lngstr['label_editquestions_hdr_questionid'] = 'ID';
$lngstr['label_editquestions_hdr_questionid_hint'] = 'ID Đề tài (Bấm để sắp xếp)';
$lngstr['label_editquestions_hdr_subjectid'] = 'Subjtec';
...
$lngstr['label_editquestions_hdr_question_points'] = 'Mark';
...
$lngstr['label_manageusers_hdr_id_hint'] = 'User ID (Bấm để sắp xếp)';
$lngstr['label_manageusers_hdr_user_notes'] = 'N';
$lngstr['label_manageusers_hdr_user_notes_hint'] = 'Notes';
$lngstr['label_manageusers_hdr_username'] = 'Username';
$lngstr['label_manageusers_hdr_username_hint'] = 'Username (Bấm để sắp xếp)';
$lngstr['label_manageusers_hdr_email'] = 'Email';
$lngstr['label_manageusers_hdr_email_hint'] = 'Email (Bấm để sắp xếp)';
$lngstr['label_manageusers_hdr_user_firstname'] = 'Firstname';
$lngstr['label_manageusers_hdr_user_firstname_hint'] = 'Họ (Bấm để sắp xếp)';
$lngstr['label_manageusers_hdr_user_lastname'] = 'Lastname';
...
$lngstr['label_subjects_hdr_subject_description'] = 'Subject description';
...
$lngstr['page_reportsmanager']['fields']['name']['id'] = 'User ID';
$lngstr['page_reportsmanager']['fields']['name']['username'] = $lngstr['label_report_hdr_username'];
...
$lngstr['page_panel_hdr_gettest'] = 'Test type';
$lngstr['page_panel_hdr_gettest_hint'] = 'Test type';
...
$lngstr['page_test_results_viewresults'] = 'Xem chi tiết kết quả';
...
$lngstr['page_subjects_subjectdescription'] = 'Mô tả đề tài:';
...
$lngstr['page_editquestion_points'] = 'Điểm số của câu hỏi';
...
$lngstr['page_editquestion_emptyquestion'] = 'Xin nhập vào câu hỏi (của) các bạn ở đây...';
...
$lngstr['page_etemplates_etemplateid'] = 'ID mẫu email:';
...
$lngstr['page_etemplates_etemplatebody'] = 'Nội dung email:';
$lngstr['page_etemplates_template_tags'] = 'Những nhãn Khung mẫu';

$lngstr['page-rtemplates']['rtemplateid'] = 'ID mẫu báo cáo:';
$lngstr['page-rtemplates']['rtemplatename'] = 'Tên báo cáo:';
$lngstr['page-rtemplates']['rtemplatedescription'] = 'Mô tả mẫu báo cáo:';
$lngstr['page-rtemplates']['rtemplatebody'] = 'Nội dung báo cáo:';
...
// Install:
$lngstr['install_title'] = 'Cài đặt - [Onthi.com_TrắcNghiệm]-[VTL_Test]';
...
<p><b>Địa chỉ trang trắc nghiệm Onthi.comt (VD:/tracnghiem/)</b> Xin chỉ rõ địa chỉ web ở đâu . Mạng(lưới) được kiểm tra sẽ được truy nhập.
<p><b>Địa chỉ gốc [Onthi.com_TrắcNghiệm]-[VTL_Test] trên server:</b> Xin chỉ rõ đường dẫn thư mục đầy đủ tới sự cài đặt này.
<p><b>[Onthi.com_TrắcNghiệm]-[VTL_Test] files URL:</b> Xin chỉ rõ địa chỉ mạng ở đâu được nạp dữ liệu những hồ sơ sẽ được truy nhập.
<p><b>[Onthi.com_TrắcNghiệm]-[VTL_Test] files directory:</b> Xin chỉ rõ một đường dẫn thư mục đầy đủ ở đâu TânPhú. Mạng(lưới) được kiểm tra có thể cất giữ nạp dữ liệu những hồ sơ. Thư mục này cần phải (thì) đọc được và viết bởi người sử dụng người phục vụ mạng (usually "nobody" or "apache").';
...
$lngstr['install_dirrootfull'] = 'Địa chỉ gốc trang trắc nghiệm [Onthi.com_TrắcNghiệm]-[VTL_Test] trên server:';
$lngstr['install_dirrootfull_doesnotexists'] = 'The "[Onthi.com_TrắcNghiệm]-[VTL_Test] directory" setting seems to be incorrect. Giá trị ở dưới đã được đặt lại.<br>';
...
$lngstr['install_db_title'] = 'Khởi tạo CSDL - [Onthi.com_TrắcNghiệm]-[VTL_Test]';
$lngstr['install_db_page1'] = 'Khởi tạo CSDL [Onthi.com_TrắcNghiệm]-[VTL_Test]';
...
$lngstr['initdb_etemplates_1_subject'] = '[Onthi.com_TrắcNghiệm]-[VTL_Test] - Báo cáo Mẫu';
...
[[Onthi.com_TrắcNghiệm]-[VTL_Test]_URL]
...
[[Onthi.com_TrắcNghiệm]-[VTL_Test]_URL]/account.php?action=activate&id=[USER_ID]&checkword=[USER_CHECKWORD]
