...
else $i_columns_text = 'resultid,result_datestart,result_datestart_formatted,id,username,user_firstname,user_lastname,testid,test_name,result_timeexceeded,result_points,result_pointsmax,result_score,grade_name';
...
$i_tablefields = array(
	...
	array($lngstr['label_report_hdr_username'], $lngstr['label_report_hdr_username_hint'], $srv_settings['table_prefix'].'users.username'),
