...
$i_userfirstname = '';
$i_isok = false;
$i_rSet1 = $g_db->SelectLimit("SELECT * FROM ".$srv_settings['table_prefix']."users WHERE username=".$f_username." AND user_enabled=1", 1);
if(!$i_rSet1) {
...
$i_email_body = str_replace(ETEMPLATE_TAG_email, $i_rSet1->fields['email'], $i_email_body);
...
sendEmail(array('from' => $i_rSet3->fields['etemplate_from'], 'to' => $i_rSet1->fields['email'], 'subject' => $i_email_subject, 'body' => $i_email_body));
}
}
if($i_rSet3)
 $i_rSet3->Close();
