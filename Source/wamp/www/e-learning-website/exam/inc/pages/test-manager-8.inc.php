...
echo '<td width="100%">&nbsp;</td><td width=2><img src="images/toolbar-right.gif" width=2 height=32></td></tr></table>';
echo '</td></tr><tr><td>';
...
writeQryTableHeaders('test-manager.php?action=groups'.$i_testids_addon.$i_2_order_addon.$i_2_url_limit_addon, $i_tablefields, $i_order_no, $i_direction);
...
if($i_2_limitcount > 0) {
	if($i_2_pageno > 1) {
 echo '<td width=32><a href="test-manager.php?action=groups&pageno2=1'.$i_testids_addon.$i_order_addon.$i_2_order_addon.$i_2_url_limitto_addon.'"><img src="images/button-first-big.gif" border=0 title="'.$lngstr['button_first_page'].'"></a></td>';
echo '<td width=32><a href="test-manager.php?action=groups&pageno2='.max(($i_2_pageno-1), 1).$i_testids_addon.$i_order_addon.$i_2_order_addon.$i_2_url_limitto_addon.'"><img src="images/button-prev-big.gif" border=0 title="'.$lngstr['button_prev_page'].'"></a></td>';
} else {
