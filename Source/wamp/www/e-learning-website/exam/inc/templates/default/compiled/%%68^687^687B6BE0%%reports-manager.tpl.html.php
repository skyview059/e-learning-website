...
<?php if ($this->_tpl_vars['g_vars']['page']['username_content']): ?><tr class=<?php echo smarty_function_getRowNo(array(), $this);?>
><td><?php echo $this->_tpl_vars['lngstr']['label_username']; ?>
</td><td><?php echo $this->_tpl_vars['g_vars']['page']['username_content']; ?>
</td></tr><?php endif; ?>
...
<td><nobr><a href="reports-manager.php?id=<?php if ($_GET['id'] != ''): ?><?php else: ?><?php echo $this->_tpl_vars['g_vars']['page']['tables']['1']['rows'][$this->_tpl_vars['i_counter']]['id']; ?>
<?php endif; ?><?php echo $this->_tpl_vars['g_vars']['page']['addon_limitto']; ?>
<?php echo $this->_tpl_vars['g_vars']['page']['addon_order']; ?>
"><?php echo smarty_function_getInTagValue(array('text' => $this->_tpl_vars['g_vars']['page']['tables']['1']['rows'][$this->_tpl_vars['i_counter']]['username']), $this);?>
</a> [<a href="users.php?id=<?php echo $this->_tpl_vars['g_vars']['page']['tables']['1']['rows'][$this->_tpl_vars['i_counter']]['id']; ?>
&action=edit" title="<?php echo $this->_tpl_vars['lngstr']['label']['view_edit_user']; ?>
"><?php echo $this->_tpl_vars['g_vars']['page']['tables']['1']['rows'][$this->_tpl_vars['i_counter']]['id']; ?>
...
&id=<?php echo $this->_tpl_vars['g_vars']['page']['tables']['1']['rows'][$this->_tpl_vars['i_counter']]['id']; ?>
<?php echo $this->_tpl_vars['g_vars']['page']['addon_order']; ?>
<?php echo $this->_tpl_vars['g_vars']['page']['addon_limit']; ?>
