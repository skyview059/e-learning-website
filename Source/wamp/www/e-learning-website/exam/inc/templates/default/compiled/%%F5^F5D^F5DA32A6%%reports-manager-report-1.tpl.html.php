...
<?php if ($this->_tpl_vars['g_vars']['page']['tables']['1']['columns_to_show']['id']): ?>
<td><?php echo $this->_tpl_vars['g_vars']['page']['tables']['1']['rows'][$this->_tpl_vars['i_counter']]['id']; ?>
</td>
<?php endif; ?>

<?php if ($this->_tpl_vars['g_vars']['page']['tables']['1']['columns_to_show']['username']): ?>
<td><?php echo smarty_function_getInTagValue(array('text' => $this->_tpl_vars['g_vars']['page']['tables']['1']['rows'][$this->_tpl_vars['i_counter']]['username']), $this);?>
</td>
<?php endif; ?>
