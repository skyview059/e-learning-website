...
$lngstr['label_editquestions_hdr_subjectid'] = 'Subjtect';
...
$lngstr['page-register']['successful'] = 'Chào "%s" ! Bạn đã đăng kí thành công. <br>Chúc tôi rất vui khi bạn tham gia học tập Online trên Onthi.com . <br>Chúc bạn học gỏi, Thành công trên con đường học vấn. <br>Nếu có gì thắc mắc hay góp ý bạn có thể liên lạc với :<br> <font color=blue>Admin: Unicorn Team.</font>';
...
// Install:
$lngstr['install_title'] = 'Cài đặt -[VTL_Test]';
...
$lngstr['install_db_title'] = 'Khởi tạo CSDL - [Onthi.com TrắcNghiệm]-[VTL_Test]';
...
[[Onthi.comt_TrắcNghiệm]-[VTL_Test]_URL]
