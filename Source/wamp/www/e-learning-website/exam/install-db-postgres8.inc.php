...
"CREATE TABLE ".$srv_settings['table_prefix']."answers (
 ...
 answer_correct SMALLINT NOT NULL default '0',
 answer_percents float NOT NULL default '0',
 isregexp SMALLINT NOT NULL default '0',
 iscasesensitive SMALLINT NOT NULL default '1',
...
"CREATE TABLE ".$srv_settings['table_prefix']."gscales_grades (
 ...
 isabsolute SMALLINT NOT NULL default '0',
...
"CREATE TABLE ".$srv_settings['table_prefix']."groups (
 ...
 access_tests SMALLINT NOT NULL default '1',
 access_testmanager SMALLINT NOT NULL default '0',
 access_gradingsystems SMALLINT NOT NULL default '0',
 access_emailtemplates SMALLINT NOT NULL default '0',
 access_reporttemplates SMALLINT NOT NULL default '0',
 access_reportsmanager SMALLINT NOT NULL default '0',
 access_questionbank SMALLINT NOT NULL default '0',
 access_subjects SMALLINT NOT NULL default '0',
 access_groups SMALLINT NOT NULL default '0',
 access_users SMALLINT NOT NULL default '0',
 access_visitors SMALLINT NOT NULL default '0',
 access_config SMALLINT NOT NULL default '0',
 PRIMARY KEY (groupid)
) WITH OIDS;",
//9917
...
//9917//9917
"INSERT INTO ".$srv_settings['table_prefix']."groups_users (groupid, id) VALUES (1, 1);",
//9917//9917
"INSERT INTO ".$srv_settings['table_prefix']."groups_users (groupid, id) VALUES (20, 2);",
	),
...
"CREATE TABLE ".$srv_settings['table_prefix']."questions (
 ...
 question_type2 SMALLINT NOT NULL default '0',
 question_shufflea SMALLINT NOT NULL default '0',
...
"CREATE TABLE ".$srv_settings['table_prefix']."resources (
 ...
 resource_forall SMALLINT NOT NULL default '1',
 resource_createdate int NOT NULL default '0',
 resource_enabled SMALLINT NOT NULL default '1',
...
"CREATE TABLE ".$srv_settings['table_prefix']."results (
 ...
 result_timeexceeded SMALLINT NOT NULL default '0',
...
"CREATE TABLE ".$srv_settings['table_prefix']."results_answers (
 ...
 result_answer_iscorrect SMALLINT NOT NULL default '0',
 result_answer_feedback text NOT NULL default '',
 result_answer_timespent int NOT NULL default '0',
 result_answer_timeexceeded SMALLINT NOT NULL default '0',
...
"CREATE TABLE ".$srv_settings['table_prefix']."tests (
 ...
 test_timeforceout SMALLINT NOT NULL default '0',
 test_timingq SMALLINT NOT NULL default '0',
 test_attempts int NOT NULL default '0',
 test_shuffleq SMALLINT NOT NULL default '0',
 test_shufflea SMALLINT NOT NULL default '0',
 test_sectionstype int NOT NULL default '0',
 test_qsperpage SMALLINT NOT NULL default '1',
 test_showqfeedback SMALLINT NOT NULL default '1',
 test_canreview SMALLINT NOT NULL default '0',
 test_result_showanswers SMALLINT NOT NULL default '0',
 test_result_showpoints SMALLINT NOT NULL default '1',
 test_result_showgrade SMALLINT NOT NULL default '0',
 test_result_showgradefeedback SMALLINT NOT NULL default '0',
 test_result_showhtml SMALLINT NOT NULL default '0',
 test_result_showpdf SMALLINT NOT NULL default '0',
 test_result_rtemplateid INT DEFAULT '0' NOT NULL,
 test_reportgradecondition SMALLINT NOT NULL default '0',
 test_result_email varchar(255) NOT NULL default '',
 test_result_emailtouser SMALLINT NOT NULL default '0',
 ...
 test_contentprotection SMALLINT NOT NULL default '0',
 test_notes text NOT NULL default '',
 test_price int NOT NULL default '0',
 test_other_repeatuntilcorrect SMALLINT NOT NULL default '0',
 test_forall SMALLINT NOT NULL default '1',
 test_createdate int NOT NULL default '0',
 test_enabled SMALLINT NOT NULL default '1',
 PRIMARY KEY (testid)
) WITH OIDS;",
	),
...
"CREATE TABLE ".$srv_settings['table_prefix']."users (
 ...
 user_birthday TIMESTAMP NOT NULL default '19000101',
...
"INSERT INTO ".$srv_settings['table_prefix']."config (configid, config_name, config_value) VALUES (53, 'editor_type', '3');",
 ...
 //9917
	'groups' => array(
	//9917
"ALTER TABLE ".$srv_settings['table_prefix']."groups ADD access_visitors SMALLINT NOT NULL default '0';",
//9917
"ALTER TABLE ".$srv_settings['table_prefix']."groups ADD access_config SMALLINT NOT NULL default '0';",
//9917
...
"ALTER TABLE ".$srv_settings['table_prefix']."results_answers ADD result_answer_timeexceeded SMALLINT NOT NULL default '0';",
	),
 
	'tests' => array(
"ALTER TABLE ".$srv_settings['table_prefix']."tests ADD test_timeforceout SMALLINT NOT NULL default '0';",
"ALTER TABLE ".$srv_settings['table_prefix']."tests ADD test_showqfeedback SMALLINT NOT NULL default '1';",
	),
...
"INSERT INTO ".$srv_settings['table_prefix']."config (configid, config_name, config_value) VALUES (54, 'upon_registration', '0');",
	...
	'groups' => array(
	//9917
"ALTER TABLE ".$srv_settings['table_prefix']."groups ADD access_reporttemplates SMALLINT NOT NULL default '0';",
	),
	 
	'tests' => array(
 
"ALTER TABLE ".$srv_settings['table_prefix']."tests ADD test_reportgradecondition SMALLINT NOT NULL default '0';",
	),
...
"ALTER TABLE ".$srv_settings['table_prefix']."users ADD user_gender SMALLINT NOT NULL default '0';",
"ALTER TABLE ".$srv_settings['table_prefix']."users ADD user_birthday TIMESTAMP NOT NULL default '19000101';",
...
"ALTER TABLE ".$srv_settings['table_prefix']."gscales_grades ADD grade_feedback text NOT NULL default '';",
	...
	'questions' => array(
"ALTER TABLE ".$srv_settings['table_prefix']."questions ADD question_shufflea SMALLINT NOT NULL DEFAULT '0';",
	),
...
"INSERT INTO ".$srv_settings['table_prefix']."etemplates (etemplateid, etemplate_name, etemplate_description, etemplate_from, etemplate_subject, etemplate_body) VALUES (5, ".($g_db->qstr($lngstr['initdb_etemplates_5_name'], get_magic_quotes_gpc())).", ".($g_db->qstr($lngstr['initdb_etemplates_5_description'], get_magic_quotes_gpc())).", ".($g_db->qstr($srv_settings['default_email'], get_magic_quotes_gpc())).", ".($g_db->qstr($lngstr['initdb_etemplates_5_subject'], get_magic_quotes_gpc())).", ".($g_db->qstr($lngstr['initdb_etemplates_5_body'], get_magic_quotes_gpc())).");",
	...
	'tests' => array(
"ALTER TABLE ".$srv_settings['table_prefix']."tests ADD test_contentprotection SMALLINT NOT NULL default '0';",
	),
...
"ALTER TABLE ".$srv_settings['table_prefix']."results_answers CHANGE result_answer_points result_answer_points FLOAT DEFAULT '0' NOT NULL;",
	...
	'tests' => array(
"ALTER TABLE ".$srv_settings['table_prefix']."tests ADD test_result_showhtml SMALLINT NOT NULL default '0';",
	),
...
$i_queries_011105 = array (
	...
	'questions' => array(
"ALTER TABLE ".$srv_settings['table_prefix']."questions ADD question_type2 SMALLINT DEFAULT '0' NOT NULL;",
	),
	 
	'tests' => array(
"ALTER TABLE ".$srv_settings['table_prefix']."tests ADD test_canreview SMALLINT NOT NULL default '0';",
"ALTER TABLE ".$srv_settings['table_prefix']."tests ADD test_result_showgradefeedback SMALLINT NOT NULL default '0';",
"ALTER TABLE ".$srv_settings['table_prefix']."tests ADD test_other_repeatuntilcorrect SMALLINT NOT NULL default '0';",
	),
...
$arrInstallQueriesSpecial['after_any'] = array (
	...
	'seq' => array(
"SELECT setval('".$srv_settings['table_prefix']."etemplates_etemplateid_seq', (SELECT max(etemplateid) FROM ".$srv_settings['table_prefix']."etemplates));",
"SELECT setval('".$srv_settings['table_prefix']."gscales_gscaleid_seq', (SELECT max(gscaleid) FROM ".$srv_settings['table_prefix']."gscales));",
//9917
"SELECT setval('".$srv_settings['table_prefix']."groups_groupid_seq', (SELECT max(groupid) FROM ".$srv_settings['table_prefix']."groups));", 
"SELECT setval('".$srv_settings['table_prefix']."rtemplates_rtemplateid_seq', (SELECT max(rtemplateid) FROM ".$srv_settings['table_prefix']."rtemplates));",
"SELECT setval('".$srv_settings['table_prefix']."subjects_subjectid_seq', (SELECT max(subjectid) FROM ".$srv_settings['table_prefix']."subjects));",
"SELECT setval('".$srv_settings['table_prefix']."users_id_seq', (SELECT max(id) FROM ".$srv_settings['table_prefix']."users));",
	),
);
