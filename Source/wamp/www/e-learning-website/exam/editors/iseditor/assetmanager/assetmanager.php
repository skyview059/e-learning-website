...
if(!$bIsReadOnly && isset($_FILES["File1"]))
	{
...
if(!$bIsReadOnly && isset($_POST["inpFileToDelete"]))
	{
...
<td valign=top style="background:url('bg.gif') no-repeat right bottom;padding-top:5px;padding-left:5px;padding-right:5px;padding-bottom:0px;">
		...
		<td>
				...
				<td nowrap>
					<span onclick="newFolder()" style="cursor:pointer;" <?php echo $sFolderAdmin;?>><u><span name="txtLang" id="txtLang">New&nbsp;Folder</span></u></span>&nbsp;
					<span onclick="deleteFolder()" style="cursor:pointer;" <?php echo $sFolderAdmin;?>><u><span name="txtLang" id="txtLang">Del&nbsp;Folder</span></u></span>
				</td>
